...
import AuctionsTableView from '../table/auctions-table';
import {
    Table,
    Paper,
    Button,
    ...
    return (
        <>
                ...
                <Table>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell>No of Requests</TableCell>
                            <TableCell />
            ...
            <Dialog open={showBiddingsTable} onClose={handleCloseBiddingsTable}>
                ...
                <DialogContent>
                    <AuctionsTableView open={showBiddingsTable} onClose={handleCloseBiddingsTable} />
                </DialogContent>
                <DialogActions>
